...
public class GolemModelDefinitions {
	...
	public static MeshDefinition createPlayerMesh(CubeDeformation def, boolean p_170827_) {
		...
		float f = 0.25F;
		if (p_170827_) {
			partdefinition.addOrReplaceChild("left_arm", CubeListBuilder.create().texOffs(32, 48).mirror().addBox(-1.0F, -2.0F, -2.0F, 3.0F, 12.0F, 4.0F, def), PartPose.offset(5.0F, 2.5F, 0.0F));
			...
			partdefinition.addOrReplaceChild("left_sleeve", CubeListBuilder.create().texOffs(48, 48).mirror().addBox(-1.0F, -2.0F, -2.0F, 3.0F, 12.0F, 4.0F, def.extend(0.25F)), PartPose.offset(5.0F, 2.5F, 0.0F));
			...
			partdefinition.addOrReplaceChild("left_arm", CubeListBuilder.create().texOffs(32, 48).mirror().addBox(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, def), PartPose.offset(5.0F, 2.0F, 0.0F));
			partdefinition.addOrReplaceChild("left_sleeve", CubeListBuilder.create().texOffs(48, 48).mirror().addBox(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, def.extend(0.25F)), PartPose.offset(5.0F, 2.0F, 0.0F));
	...
	public static LayerDefinition createDogLayer(CubeDeformation def) {
		...
		CubeListBuilder cubelistbuilder_mirror = CubeListBuilder.create().texOffs(0, 18).mirror().addBox(0.0F, 0.0F, -1.0F, 2.0F, 8.0F, 2.0F, def);
		partdefinition.addOrReplaceChild("right_hind_leg", cubelistbuilder, PartPose.offset(-2.5F, 16.0F, 7.0F));
		partdefinition.addOrReplaceChild("left_hind_leg", cubelistbuilder_mirror, PartPose.offset(0.5F, 16.0F, 7.0F));
		partdefinition.addOrReplaceChild("right_front_leg", cubelistbuilder, PartPose.offset(-2.5F, 16.0F, -4.0F));
		partdefinition.addOrReplaceChild("left_front_leg", cubelistbuilder_mirror, PartPose.offset(0.5F, 16.0F, -4.0F));
