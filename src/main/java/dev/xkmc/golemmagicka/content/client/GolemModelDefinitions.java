...
public class GolemModelDefinitions {
	...
	public static MeshDefinition buildGolemBaseLayers(CubeDeformation def) {
		...
		partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -12.0F, -5.5F, 8.0F, 10.0F, 8.0F, def).texOffs(24, 0).addBox(-1.0F, -5.0F, -7.5F, 2.0F, 4.0F, 2.0F, def), PartPose.offset(0.0F, -7.0F, -2.0F));
		...
		partdefinition.addOrReplaceChild("left_arm", CubeListBuilder.create().texOffs(60, 58).addBox(9.0F, -2.5F, -3.0F, 4.0F, 14.0F, 6.0F, def), PartPose.offset(0.0F, -7.0F, 0.0F));
		...
		root2.addOrReplaceChild("left_forearm", CubeListBuilder.create().texOffs(60, 72).addBox(8.99F, 0.0F, -6.0F, 4.0F, 16.0F, 6.0F, def), PartPose.offsetAndRotation(0.0F, 11.5F, 3.0F, 0.0F, 0.0F, 0.0F));
		return mesh;
	}
	...
	public static MeshDefinition createPlayerMesh(CubeDeformation def, boolean p_170827_) {
		...
		partdefinition.addOrReplaceChild("left_pants", CubeListBuilder.create().texOffs(0, 48).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, def.extend(0.25F)), PartPose.offset(1.9F, 12.0F, 0.0F));
