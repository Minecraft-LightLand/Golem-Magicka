 ...
 * @since 2026-01-11
 */
public class TLMCastingAnimateStateHolder implements IMagicCastingState, IGolemCastingStateHolder {
	...
	public TLMCastingAnimateStateHolder() {
		this(CastingPhase.NONE, false);
	}

	public TLMCastingAnimateStateHolder(CastingPhase phase, boolean cancelled) {
		this.phase = phase;
