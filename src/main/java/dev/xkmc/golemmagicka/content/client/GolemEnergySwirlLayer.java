...
public class GolemEnergySwirlLayer<
	...
	public GolemEnergySwirlLayer(RenderLayerParent<T, M> pRenderer, M model, ResourceLocation texture, Supplier<MobEffect> shouldRenderFlag) {
		this(pRenderer, model, texture, (living) -> living.hasEffect(shouldRenderFlag.get()));
	}
